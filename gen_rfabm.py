...
default_Dout = 1       #1 to use default Dout, 0 for no biological diagnostics.
...
os.system(f'rm -f {FOLDER_NAME}/varinfo.dat {FOLDER_NAME}/rfabm.in')
os.system(f'cp {yamlfile} {FOLDER_NAME}/')

outfile1 = 'Src_modify/rfabm_mod.h'
outfile2 = 'Src_modify/rfabm_inp.h'
outfile3 = 'Src_modify/rfabm_var.h'
outfile4 = f'{FOLDER_NAME}/varinfo.dat'
outfile5 = f'{FOLDER_NAME}/rfabm.in'
...
defDoutOther_2d = []
defDoutOther_3d = ['B_OXYDEP_GrazPhy', 'B_OXYDEP_GrazPOM', 'B_OXYDEP_LimN', 'B_OXYDEP_LimT', 'B_OXYDEP_LimLight', 'B_OXYDEP_GrowthPhy', 'B_OXYDEP_DOM_decay_ox',
                   'B_OXYDEP_DOM_decay_denitr', 'B_OXYDEP_POM_decay_denitr', 'B_OXYDEP_Autolys']
...
with open(outfile1,'w') as f:
   ...
   for i,variable in enumerate(DiaBio_2d,1):
      l1 = len(variable.output_name)  # type: ignore
      if l1>lmax:
         vstr = 'HD' + str(i)
         l1 = len(vstr)
      else:
         vstr = variable.output_name  # type: ignore
      HDstrfullv.append(variable.output_name)  # type: ignore
      HDstrv.append(vstr)
   ...
   for i,variable in enumerate(DiaBio_3d,1):
      ...
      if l1>lmax:
         ...
         vstr = variable.output_name  # type: ignore
      BDstrfullv.append(variable.output_name)  # type: ignore
      BDstrv.append(vstr)
      f.write(' '*nspace + 'integer :: i' + vstr + ' = ' + str(i) + '\n')
   f.write('#endif')
