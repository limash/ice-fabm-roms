...
!
            ...
            CASE(                                                       &
     & 'Dout(iB_OXYDEP_GrazPhy)')
              IF (iDbio3(                                               &
     & iB_OXYDEP_GrazPhy).eq.0) THEN
                IF (Master) WRITE (out,40)                              &
     ...
     & iB_OXYDEP_GrazPhy)
              ...
              END DO
            CASE(                                                       &
     & 'Dout(iB_OXYDEP_GrazPOM)')
              IF (iDbio3(                                               &
     & iB_OXYDEP_GrazPOM).eq.0) THEN
                IF (Master) WRITE (out,40)                              &
     ...
     & iB_OXYDEP_LimT)
              ...
              END DO
            CASE(                                                       &
     & 'Dout(iB_OXYDEP_LimLight)')
              IF (iDbio3(                                               &
     & iB_OXYDEP_LimLight).eq.0) THEN
                IF (Master) WRITE (out,40)                              &
     ...
     & iB_OXYDEP_LimLight)
              ...
              END DO
            CASE(                                                       &
     & 'Dout(iB_OXYDEP_GrowthPhy)')
              IF (iDbio3(                                               &
     & iB_OXYDEP_GrowthPhy).eq.0) THEN
                IF (Master) WRITE (out,40)                              &
     ...
     & iB_OXYDEP_GrowthPhy)
              ...
              END DO
            CASE(                                                       &
     & 'Dout(iB_OXYDEP_DOM_decay_ox)')
              IF (iDbio3(                                               &
     & iB_OXYDEP_DOM_decay_ox).eq.0) THEN
                IF (Master) WRITE (out,40)                              &
     & 'iDbio3(iB_OXYDEP_DOM_decay_ox)'
              ...
              Npts=load_l(Nval, Cval, Ngrids, Lbio)
              i=iDbio3(                                                 &
     & iB_OXYDEP_DOM_decay_ox)
              DO ng=1,Ngrids
                Dout(i,ng)=Lbio(ng)
              END DO
            CASE(                                                       &
     & 'Dout(iB_OXYDEP_DOM_decay_denitr)')
              IF (iDbio3(                                               &
     & iB_OXYDEP_DOM_decay_denitr).eq.0) THEN
                IF (Master) WRITE (out,40)                              &
     & 'iDbio3(iB_OXYDEP_DOM_decay_denitr)'
              ...
              Npts=load_l(Nval, Cval, Ngrids, Lbio)
              i=iDbio3(                                                 &
     & iB_OXYDEP_DOM_decay_denitr)
              DO ng=1,Ngrids
                Dout(i,ng)=Lbio(ng)
              END DO
            CASE(                                                       &
     & 'Dout(iB_OXYDEP_POM_decay_denitr)')
              IF (iDbio3(                                               &
     & iB_OXYDEP_POM_decay_denitr).eq.0) THEN
                IF (Master) WRITE (out,40)                              &
     & 'iDbio3(iB_OXYDEP_POM_decay_denitr)'
              ...
              Npts=load_l(Nval, Cval, Ngrids, Lbio)
              i=iDbio3(                                                 &
     & iB_OXYDEP_POM_decay_denitr)
              DO ng=1,Ngrids
                Dout(i,ng)=Lbio(ng)
              END DO
            CASE(                                                       &
     & 'Dout(iB_OXYDEP_Autolys)')
              IF (iDbio3(                                               &
     & iB_OXYDEP_Autolys).eq.0) THEN
                IF (Master) WRITE (out,40)                              &
     ...
     & iB_OXYDEP_Autolys)
              ...
              END DO
# ifdef DEBUG
            write(*,*) "Done input of diagnostic output options Dout"
# endif
#endif
