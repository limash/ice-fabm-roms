...
export ROMS_APPLICATION=a20_v3_oxydep
...
export MY_PROJECT_DIR=${MY_ROOT_DIR}/Run_v2j
...
#
export MY_ROMS_SRC=${MY_ROOT_DIR}/roms_src/ROMS_v37_KATE

###Inserted PWA 01/07/2014
NEW_SRC_DIR=${MY_ROMS_SRC}/ROMS/Nonlinear/Biology

# Decompress the ROMS tarball -PWA 18/11/2021
tar -xf ${MY_ROMS_SRC}.tar.gz -C ${MY_ROOT_DIR}/roms_src/
...
###PWA Inserted 04/03/2015
 export FABM_INCDIR=/cluster/projects/nn9630k/A20/local/fabm/roms/include
 export FABM_LIBDIR=/cluster/projects/nn9630k/A20/local/fabm/roms/lib
